...
figure, imshow(img);
[center, radius, area] = findSphere(img);
save('sphere_properties', 'center', 'radius', 'area');
...
figure, surf(im2double(imresize(surf_img, 0.3)), 'EdgeColor', 'none');
camlight
print(gcf, '-dpng', '-r150', 'vase3Drecon.png')