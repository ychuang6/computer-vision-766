...
signAcademicHonestyPolicy('YJC', 'ychuang6');
...
template_half_window_size = 30; % Half size of the template window 
...
tracking_params.rect = [198 64 31 119];

% Half size of the search window
tracking_params.search_half_window_size = 20;
...
% to specify the target of interest
%tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [154 136 45 43];

% Half size of the search window
tracking_params.search_half_window_size = 30;
% Number of bins in the color histogram
tracking_params.bin_n = 22;           
...
% to specify the target of interest
%tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [314 234 27 71];

% Half size of the search window
tracking_params.search_half_window_size = 22 ;
% Number of bins in the color histogram
